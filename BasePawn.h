...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Base Mesh", meta = (AllowPrivateAccess = "true"))
	UStaticMeshComponent* BaseMesh;
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Turret Mesh", meta = (AllowPrivateAccess = "true"))
	UStaticMeshComponent* TurretMesh;
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Projectile Spawn Point", meta = (AllowPrivateAccess = "true"))
